...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "RXNDBYDb#C68xOpr3ix3o92HoxOAIV9GnxakQlNXDtQ63u5i9AMM",
    CAPTION: process.env.CAPTION || "POWERED BY PAGNGNASIRI THERO",
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR IM ONLINE I'M PAGNGNASIRI THERO 😊♻️",
    ...
    DEV: process.env.DEV || "94752677804",//replace with your whatsapp number        
